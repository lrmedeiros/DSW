...
<head>
  ...
  <style>
    <?php include './app/view/resources/styles/global.css'; ?><?php include './app/view/resources/pages/Register/styles.css'; ?>
  </style>
  <title>Organizei | Registrar</title>
</head>
...
<body>
  ...
  <main class="container">
    <header class="mb-3 row">
      <h1>Registrar-se no Organizei</h1>
    </header>
